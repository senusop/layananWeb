...
--
-- Host: localhost
-- Generation Time: Apr 03, 2016 at 11:26 
...
--
-- Table structure for table `tb_jadwal_prakerin`
--

CREATE TABLE IF NOT EXISTS `tb_jadwal_prakerin` (
...
--
-- Dumping data for table `tb_jadwal_prakerin`
--

INSERT INTO `tb_jadwal_prakerin` (`jadwal_id`, `thn_ajaran_id`, `gelombang`, `mulai`, `selesai`, `kelompok_id`) VALUES
(1, 26, 'Gelombang 1', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 2),
(2, 26, 'Gelombang 1', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1);
...
--
-- Table structure for table `tb_kelompok_prakerin`
--

CREATE TABLE IF NOT EXISTS `tb_kelompok_prakerin` (
  `kelompok_id` int(11) NOT NULL AUTO_INCREMENT,
  `nama_kelompok` varchar(3) NOT NULL,
...
--
-- Dumping data for table `tb_kelompok_prakerin`
--

INSERT INTO `tb_kelompok_prakerin` (`kelompok_id`, `nama_kelompok`, `pembimbing_id`, `peserta_id`) VALUES
(1, 'A', 2, 1),
(2, 'A', 2, 2);
...
CREATE TABLE IF NOT EXISTS `tb_monitoring` (
  ...
  `gelombang` varchar(15) NOT NULL,
  `pembimbing_id` int(11) NOT NULL,
  `monitor_ke_1` datetime NOT NULL,
  `monitor_ke_2` datetime NOT NULL,
...
INSERT INTO `tb_monitoring` (`monitoring_id`, `thn_ajaran_id`, `gelombang`, `pembimbing_id`, `monitor_ke_1`, `monitor_ke_2`) VALUES
(1, 26, 'gelombang 1', 2, '2016-04-04 10:24:33', '2016-04-21 10:24:36'),
(3, 26, 'gelombang 2', 1, '2016-04-04 10:24:52', '2016-04-21 10:24:56');
...
--
-- Table structure for table `tb_peserta_prakerin`
--

CREATE TABLE IF NOT EXISTS `tb_peserta_prakerin` (
...
--
-- Dumping data for table `tb_peserta_prakerin`
--

INSERT INTO `tb_peserta_prakerin` (`peserta_id`, `murid_id`, `perusahaan_id`) VALUES
(1, 19, 6),
(2, 18, 6);
