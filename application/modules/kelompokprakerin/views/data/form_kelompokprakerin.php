  ...
  <div class="content">
	<div class="block  block-bordered">
		<div class="block-header bg-gray-lighter">
				<h3 class="block-title"> <?php echo $titleForm;?> <span class="label label-info"><?php echo $nama_kelompokprakerin;?></span></h3>
		</div>
				...
				<div class="block-content">
						...
						<div class="col-lg-12">
							<div class="form-group ">
								<div class="col-sm-7">
									 <STRONG><span class="text-primary"><i class="si si-user-follow"></i>  Tambah kelompokprakerin Baru</span></STRONG>
								</div>
							</div>
									...
									<div class="col-lg-5">
										<div class="form-group">
											...
											<select id="basic" name="murid_id" class="selectpicker show-tick form-control" data-live-search="false" style="width: 100%;" data-placeholder="pilih satu">
												<option value="<?php echo $murid_id;?>"><?php echo $nama_kelompokprakerin;?></option><!-- Required for data-placeholder attribute to work with Chosen plugin -->
												<?php
													foreach($murid as $m)
													{
												?>
				...
				<div class="block-content bg-gray-lighter block-content-mini block-content-full border-t">
					<div class="row">
						...
						<div class="col-xs-12 text-right">
							<?php echo anchor('kelompokprakerin',' Kembali','class="btn btn-sm btn-default"');?>
