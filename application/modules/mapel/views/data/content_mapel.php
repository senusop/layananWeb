 ...
 <!-- Page Header -->
	...
	<!-- END Page Header -->
		<div class="col-sm-12">
			<form action="<?php echo base_url('mapel/multi');?>" method="POST"> 
				<div class="content">
					<div class="block">
						<div class="block-header">
							<?php echo anchor('mapel/tambah','<i class="fa fa-plus"></i> Tambah','class="btn btn-sm btn-success" data-toggle="tooltip" title="Tambah mapel"');?>
									...
									<tr>
										...
										<td class="text-center">
											<label class="css-input css-checkbox css-checkbox-success">
												<input type="checkbox" value="<?php echo $data->mapel_id;?>" id="row_<?php echo $no;?>" name="mapel_id[]"><span></span>
											</label>
										</td>
										<td class=""><?php echo $data->mapel_nama;?></td>
										<td class=""><?php echo $data->singkatan;?></td>
										<td class="text-center">
											<div class="btn-group">
												<a href="mapel/edit/<?php echo $data->mapel_id;?>" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Edit mapel"><i class="fa fa-pencil"></i></a>
												<a href="javascript:;" data-id="<?php echo $data->mapel_id;?>" data-toggle="modal" data-target="#modal-konfirmasi" class="btn btn-xs btn-danger" type="button"    data-toggle="confirmation"><i class="fa fa-times"></i></a>
											</div>
										</td>
									</tr>
											<?php  
...
<script>
	...
	$(document).ready(function(){
		...
		$('#modal-konfirmasi').on('show.bs.modal', function (event) {
			...
			modal.find('#hapus-true').attr("href","mapel/hapus/"+id); 
