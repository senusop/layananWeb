 ...
 <!-- Page Header -->
	...
	<!-- END Page Header -->
		<div class="col-sm-12">
			<form action="<?php echo base_url('jenis_perusahaan/multi');?>" method="POST"> 
				<div class="content">
					<div class="block">
						<div class="block-header">
							<?php echo anchor('jenis_perusahaan/tambah','<i class="fa fa-plus"></i> Tambah','class="btn btn-sm btn-success" data-toggle="tooltip" title="Tambah Jenis Perusahaan"');?>
							...
							<table class="table table-condensed js-table-checkable table-hover js-dataTable-full">
								<thead>
									<tr>
										...
										<th><strong>Jenis Perusahaan</strong> </th>
								...
								<tbody>
									<?php
									$no=1;
										foreach($jenis_perusahaan as $data)
											{
									...
									<tr>
										...
										<td class="text-center">
											<label class="css-input css-checkbox css-checkbox-success">
												<input type="checkbox" value="<?php echo $data->jenis_perusahaan_id;?>" id="row_<?php echo $no;?>" name="jenis_perusahaan_id[]"><span></span>
											</label>
										</td>
										<td class=""><?php echo $data->jenis_perusahaan;?></td>
										<td class="text-center">
											<div class="btn-group">
												<a href="jenis_perusahaan/edit/<?php echo $data->jenis_perusahaan_id;?>" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Edit jenis perusahaan"><i class="fa fa-pencil"></i></a>
												<a href="javascript:;" data-id="<?php echo $data->jenis_perusahaan_id;?>" data-toggle="modal" data-target="#modal-konfirmasi" class="btn btn-xs btn-danger" type="button"    data-toggle="confirmation"><i class="fa fa-times"></i></a>
											</div>
										</td>
									</tr>
											<?php  
...
<script>
	...
	$(document).ready(function(){
		...
		$('#modal-konfirmasi').on('show.bs.modal', function (event) {
			...
			modal.find('#hapus-true').attr("href","jenis_perusahaan/hapus/"+id); 
