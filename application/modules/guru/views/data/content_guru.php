 ...
 <!-- Page Header -->
	...
	<!-- END Page Header -->
		<div class="col-sm-12">
			<form action="<?php echo base_url('guru/multi');?>" method="POST"> 
				<div class="content">
					<div class="block">
						<div class="block-header">
							<?php echo anchor('guru/tambah','<i class="fa fa-plus"></i> Tambah','class="btn btn-sm btn-success" data-toggle="tooltip" title="Tambah guru"');?>
								...
								<thead>
									<tr>
										...
										<th class="text-center">
											<label data-toggle="tooltip" title="Pilih Semua" class="checkAll css-input css-checkbox css-checkbox-success remove-margin-t remove-margin-b">
									...
									<tr>
										...
										<td class="text-center">
											<label class="css-input css-checkbox css-checkbox-success">
												<input type="checkbox" value="<?php echo $data->guru_id;?>" id="row_<?php echo $no;?>" name="guru_id[]"><span></span>
											</label>
										</td>
										<td class=""><?php echo $data->guru_nip;?></td>
										<td class=""><?php echo $data->guru_nama;?></td>
										<td class="hidden-xs"><?php echo $data->tempat_lahir;?> <?php echo $data->tgl_lahir;?></td>
										<td class="hidden-xs"><?php echo $data->guru_status;?> </td>
										<td class="hidden-xs"><?php echo $data->gender;?></td>
										<td class="text-center">
											<div class="btn-group">
												<a href="guru/data_guru/<?php echo $data->guru_id;?>" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Edit guru"><i class="fa fa-pencil"></i></a>
												<a href="javascript:;" data-id="<?php echo $data->guru_id;?>" data-toggle="modal" data-target="#modal-konfirmasi" class="btn btn-xs btn-danger" type="button"    data-toggle="confirmation"><i class="fa fa-times"></i></a>
											</div>
										</td>
									</tr>
											<?php  
...
<script>
	...
	$(document).ready(function(){
		...
		$('#modal-konfirmasi').on('show.bs.modal', function (event) {
			...
			modal.find('#hapus-true').attr("href","guru/hapus/"+id); 
