 ...
 <!-- Page Header -->
                ...
                <!-- END Page Header -->
				 <!-- Dynamic Table Full -->
			<form action="<?php echo base_url('kajur/multi');?>" method="POST"> 
				<div class="content">
					<div class="block">
						<div class="block-header">
							<?php echo anchor('kajur/tambah','<i class="fa fa-plus"></i> Tambah','class=" btn btn-sm btn-success" data-toggle="tooltip" title="Tambah kajur"');?>
							...
							<table class="table table-condensed js-table-checkable table-hover js-dataTable-full">
								<thead>
									<tr>
										...
										<th>Tahun Ajaran </th>
										<th>Jurusan </th>
										<th class="hidden-xs">Ketua Jurusan</th>
									...
									<tr>
										...
										<td class="text-center">
											<label class="css-input css-checkbox css-checkbox-success">
												<input type="checkbox" value="<?php echo $data->kajur_id;?>" id="row_<?php echo $no;?>" name="kajur[]"><span></span>
											</label>
										</td>
										<td class=""><?php echo $data->tahun;?></td>
										<td class="hidden-xs"><?php echo $data->jurusan_nama;?> <span class="text-muted">(<?php echo $data->jurusan_singkat;?>)</span> </td>
										<td class="hidden-xs"><?php echo $data->guru_nama;?></span></td>
										
										<td class="text-center">
											<div class="btn-group">
												<a href="kajur/edit/<?php echo $data->kajur_id;?>" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Edit kajur"><i class="fa fa-pencil"></i></a>
												<a href="javascript:;" data-id="<?php echo $data->kajur_id;?>" data-toggle="modal" data-target="#modal-konfirmasi" class="btn btn-xs btn-danger" type="button" title="Hapus kajur"><i class="fa fa-times"></i></a>
											</div>
										</td>
									</tr>
											<?php  
...
<script>
	...
	$(document).ready(function(){
		...
		$('#modal-konfirmasi').on('show.bs.modal', function (event) {
			...
			modal.find('#hapus-true').attr("href","kajur/hapus/"+id); 
