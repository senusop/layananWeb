 ...
 <!-- Page Header -->
                ...
                <!-- END Page Header -->
				 <!-- Dynamic Table Full -->
			<form action="<?php echo base_url('jurusan/multi');?>" method="POST"> 
				<div class="content">
					<div class="block block-bordered">
						<div class="block-header bg-gray-lighter">
							<?php echo anchor('jurusan/tambah','<i class="fa fa-plus"></i> Tambah','class=" btn btn-sm btn-success" data-toggle="tooltip" title="Tambah Jurusan"');?>
							...
							<table class="table table-condensed js-table-checkable table-hover js-dataTable-full">
								<thead>
									<tr>
										...
										<th>Jurusan </th>
										<th class="hidden-xs">Akreditas</th>
										...
										foreach($dataJurusan as $data)
											{
												...
												if($data->akreditasi=="A")
													{
														$label="label-success";
													}
												elseif($data->akreditasi=="B")
													{
														$label="label-primary";
													}
												elseif($data->akreditasi=="C")
													{
														$label="label-warning";
													}
												elseif($data->akreditasi=="D")
													{
														$label="label-danger";
													}
									...
									<tr>
										...
										<td class="text-center">
											<label class="css-input css-checkbox css-checkbox-success">
												<input type="checkbox" value="<?php echo $data->jurusan_id;?>" id="row_<?php echo $no;?>" name="jurusan_id[]"><span></span>
											</label>
										</td>
										<td class=""><?php echo $data->jurusan_nama;?> <span class="text-muted"><small>(<?php echo $data->jurusan_singkat;?>)</small></span></td>
										<td class="hidden-xs"><span class="label <?php echo $label;?>"><?php echo $data->akreditasi;?></span></td>
										<td class="text-center">
											<div class="btn-group">
												<a href="jurusan/edit/<?php echo $data->jurusan_id;?>" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Edit Jurusan"><i class="fa fa-pencil"></i></a>
												<a href="javascript:;" data-id="<?php echo $data->jurusan_id;?>" data-toggle="modal" data-target="#modal-konfirmasi" class="btn btn-xs btn-danger" type="button" title="Hapus Jurusan"><i class="fa fa-times"></i></a>
											</div>
										</td>
									</tr>
											<?php  
...
<script>
	...
	$(document).ready(function(){
		...
		$('#modal-konfirmasi').on('show.bs.modal', function (event) {
			...
			modal.find('#hapus-true').attr("href","jurusan/hapus/"+id); 
