 ...
 <!-- Page Header -->
	...
	<!-- END Page Header -->
		<div class="col-sm-12">
			<form action="<?php echo base_url('pembimbing/multi');?>" method="POST"> 
				<div class="content">
					<div class="block">
						<div class="block-header">
							<?php echo anchor('pembimbing/tambah','<i class="fa fa-plus"></i> Tambah','class="btn btn-sm btn-success" data-toggle="tooltip" title="Tambah pembimbing"');?>
							...
							<table class="table table-condensed js-table-checkable table-hover js-dataTable-full">
								<thead>
									<tr>
										...
										<th><strong>Nama Pembiming</strong> </th>
									...
									<tr>
										...
										<td class="text-center">
											<label class="css-input css-checkbox css-checkbox-success">
												<input type="checkbox" value="<?php echo $data->pembimbing_id;?>" id="row_<?php echo $no;?>" name="pembimbing_id[]"><span></span>
											</label>
										</td>
										<td class=""><?php echo $data->guru_nama;?></td>
										<td class=""><?php echo $data->jurusan_nama;?></td>
										<td class=""><?php echo $data->active;?></td>
										<td class="text-center">
											<div class="btn-group">
												<a href="pembimbing/edit/<?php echo $data->pembimbing_id;?>" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Edit pembimbing"><i class="fa fa-pencil"></i></a>
												<a href="javascript:;" data-id="<?php echo $data->pembimbing_id;?>" data-toggle="modal" data-target="#modal-konfirmasi" class="btn btn-xs btn-danger" type="button"    data-toggle="confirmation"><i class="fa fa-times"></i></a>
											</div>
										</td>
									</tr>
											<?php  
...
<script>
	...
	$(document).ready(function(){
		...
		$('#modal-konfirmasi').on('show.bs.modal', function (event) {
			...
			modal.find('#hapus-true').attr("href","pembimbing/hapus/"+id); 
