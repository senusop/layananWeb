									...
									<div class="block-content">
											<div class="col-lg-12">
												...
												<div class="row">
													<div class="col-sm-12">
														<div class="form-group">
															<label class="control-label">Data Guru</label>
															<select id="basic" class="selectpicker show-tick form-control" data-live-search="true" name="dataGuru" style="width: 100%;" data-placeholder="Pilih Ketua kajur">
																<option value=""></option><!-- Required for data-placeholder attribute to work with Chosen plugin -->
