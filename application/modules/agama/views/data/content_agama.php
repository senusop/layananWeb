 ...
 <!-- Page Header -->
	...
	<!-- END Page Header -->
		<div class="col-sm-12">
			<form action="<?php echo base_url('agama/multi');?>" method="POST"> 
				<div class="content">
					<div class="block">
						<div class="block-header">
							<?php echo anchor('agama/tambah','<i class="fa fa-plus"></i> Tambah','class="btn btn-sm btn-success" data-toggle="tooltip" title="Tambah Agama"');?>
							<input type="submit"  name="suntingBanyak" id="suntingBanyak" class="btn btn-default btn-sm" value="sunting" data-toggle="tooltip" title="Sunting Yang Ditandai">
									...
									<tr>
										...
										<td class="text-center">
											<label class="css-input css-checkbox css-checkbox-success">
												<input type="checkbox" value="<?php echo $data->agama_id;?>" id="row_<?php echo $no;?>" name="agama_id[]"><span></span>
											</label>
										</td>
										<td class=""><?php echo $data->agama;?></td>
										<td class="text-center">
											<div class="btn-group">
												<a href="agama/edit/<?php echo $data->agama_id;?>" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Edit Agama"><i class="fa fa-pencil"></i></a>
												<a href="javascript:;" data-id="<?php echo $data->agama_id;?>" data-toggle="modal" data-target="#modal-konfirmasi" class="btn btn-xs btn-danger" type="button"    data-toggle="confirmation"><i class="fa fa-times"></i></a>
											</div>
										</td>
									</tr>
											<?php  
...
<script>
	...
	$(document).ready(function(){
		...
		$('#modal-konfirmasi').on('show.bs.modal', function (event) {
			...
			modal.find('#hapus-true').attr("href","agama/hapus/"+id); 
